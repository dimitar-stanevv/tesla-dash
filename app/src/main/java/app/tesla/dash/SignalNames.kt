...
object SName {
    const val driveMode = "driveMode"
    const val acceleratorPedalPosition = "acceleratorPedalPosition"
    const val ductTargetLeft = "ductTargetLeft"
    const val motorMode = "motorMode"
    const val wiperSpeed = "wiperSpeed"
    const val wiperSpeed2 = "wiperSpeed2"
    const val tractionControlMode = "tractionControlMode"
    const val tractionControlMode2 = "tractionControlMode2"
    const val tractionControlMode3 = "tractionControlMode3"
    const val washerFluidLevel = "washerFluidLevel"
