...
class CANSignalHelper(val sharedPreferences: SharedPreferences) {
    ...
    private fun createCANSignals() {
        insertCANSignal(SName.acceleratorPedalPosition, Constants.vehicleBus, Hex(0x118), 32, 8, 0.4f, 0f)
        insertCANSignal(SName.driveMode, Constants.vehicleBus, Hex(0x334), 5, 2, 1f, 0f)
        insertCANSignal(SName.motorMode, Constants.vehicleBus, Hex(0x334), 34, 2, 1f, 0f)
        insertCANSignal(SName.wiperSpeed, Constants.vehicleBus, Hex(0x3E9), 4, 4, 1f, 0f)
        insertCANSignal(SName.wiperSpeed2, Constants.vehicleBus, Hex(0x2E1), 8, 4, 1f, 0f)
        insertCANSignal(SName.tractionControlMode, Constants.vehicleBus, Hex(0x2B6), 4, 3, 1f, 0f)
        insertCANSignal(SName.tractionControlMode2, Constants.vehicleBus, Hex(0x293), 2, 3, 1f, 0f)
        insertCANSignal(SName.tractionControlMode3, Constants.vehicleBus, Hex(0x118), 40, 3, 1f, 0f)
        insertCANSignal(SName.washerFluidLevel, Constants.vehicleBus, Hex(0x321), 32, 2, 1f, 0f)
        insertCANSignal(SName.elevation, Constants.vehicleBus, Hex(0x3D8), 0, 14, 1f, 0f)
        ...
        insertCANSignal(SName.ductTargetLeft, Constants.vehicleBus, Hex(0x243), 48, 8, 0.5f, -40f)
